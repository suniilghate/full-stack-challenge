...
async function fetchProducts() {
    try {
        const response = await fetch(localhost + "/api/data-info.php?fetch=director");
...
function renderPage(pageNumber, data) {
    ...
    productsToShow.forEach(product => {
        ...
        <td><a href="${localhost}/public/index.php?fetch=single-director&id=${product.id}" class="page-link">${product.first_name} ${product.last_name}</a></td>
